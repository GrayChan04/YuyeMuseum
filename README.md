...
榆野博物馆是一个使用 Vue 3 + Vite 构建的粉丝自发线上展示馆。V1.4 在 V1.3 功能边界内重新简化 YUE 建筑 Logo，并把小草坪版头统一到全站的暖纸色视觉体系；项目不包含未经核实的真实粉圈历史。

本轮视觉补充见 [Inputs/需求文档-v1.4.md](Inputs/需求文档-v1.4.md)，完整功能范围继续以 [Inputs/需求文档-v1.3.md](Inputs/需求文档-v1.3.md) 为准，此前版本仍保留在 `Inputs/` 中。
