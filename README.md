...
榆野博物馆是一个使用 Vue 3 + Vite 构建的粉丝自发线上展示馆。V1.2 用四件虚构演示馆藏验证关键词搜索、横向点击时间轴、小草坪和响应式体验，不包含未经核实的真实粉圈历史。

本轮实现范围见 [Inputs/需求文档-v1.2.md](Inputs/需求文档-v1.2.md)，此前版本仍保留在 `Inputs/` 中。
